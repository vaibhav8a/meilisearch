...
use meilisearch_types::milli::{self, Filter, FilterCondition, IndexFilter};
...
pub fn parse_local_index_filter(
    ...
    let mut on_foreign_filter = |filter| {
    ...
    Ok(Some(IndexFilter::from_filter(filter, &mut on_foreign_filter).map_err(|e| {
